  ...
  return (
    <Container className={"relative bg-dark-blue flex justify-center"}>
      ...
      >
        <div
          className={
            "flex lg:flex-row flex-col gap-x-[10%] items-center justify-center self-center lg:mt-16 mt-10"
          }
        >
          <motion.svg
          ...
          <motion.section
            ...
            className={"text-gray-100 flex flex-col gap-8"}
          >
            ...
            <div className={"bg-gray-100 rounded p-4 space-y-3 lg:w-full"}>
              ...
              <Link
                href={`tel:+48698536476$`}
                className={
                  "text-dark-blue p-2 rounded bg-light-orange text-2xl sm:w-1/2 hover:bg-dark-orange transition block w-full self-center text-center mx-auto"
                }
              >
                Zadzwoń!
              </Link>
